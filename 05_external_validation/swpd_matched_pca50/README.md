...
**Как читать графики:** серый `MEL80` — это **акустический target авторского
подхода**, который мы заново прогнали как контроль в нашем matched-протоколе.
Цветные `Whisper L3/L4/L5` — **наша замена MEL на представления Whisper**.
Таким образом, число MEL не скопировано из статьи: и контроль, и наши варианты
пересчитаны нами на одних пациентах и одинаковых splits/decoder/metric.
...
|---|---:|---:|---:|
| Авторский target: MEL80 (наш контрольный прогон) | 0,02388 ± 0,00956 | [0,01588; 0,03187] | 1,04511 ± 0,01397 |
| Наша замена: Whisper L3 | 0,05327 ± 0,01828 | [0,03799; 0,06856] | 0,89148 ± 0,01155 |
| Наша замена: Whisper L4 | 0,05397 ± 0,01726 | [0,03954; 0,06840] | 0,92196 ± 0,01227 |
| Наша замена: Whisper L5 | **0,05522 ± 0,01685** | **[0,04113; 0,06930]** | **0,87929 ± 0,01589** |
